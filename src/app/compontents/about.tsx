...
export default function About() {
  return (
    <div id='about' className='mb-[300px] md:mb-0 h-[100vh] flex flex-col justify-center items-center '>
    <motion.div id='about' className='w-full h-full flex flex-col items-center'
      ...
      <h1 className='text-5xl md:text-7x1 md:mb-0 mb-[100px] font-mono'> About Me</h1>
